      ...
      <div className="container">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="space-y-3">
            <h3 className="text-lg font-medium">Assistify Warranty</h3>
            <p className="text-sm text-muted-foreground">
              AI-powered assistant to help users efficiently manage warranty claims.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/claims" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  Claim Submission
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 border-t pt-6">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <p className="text-sm text-muted-foreground">
              © {currentYear} Assistify Warranty. All rights reserved.
            </p>
